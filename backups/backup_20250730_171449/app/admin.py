...
class SystemUpdateAdmin(admin.ModelAdmin):
    ...
    def get_urls(self):
        ...
        custom_urls = [
            ...
            path('<int:pk>/installation-logs/', self.admin_site.admin_view(self.installation_logs_view), name='app_systemupdate_logs'),
        ]
        return custom_urls + urls
    ...
    def installation_logs_view(self, request, pk):
        ...
        try:
            ...
            return JsonResponse({
                'status': 'success',
                'logs': update.Installation_Log or 'No installation logs available',
